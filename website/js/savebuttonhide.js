...
const submitButtonEmail = document.getElementById('submitBtnEmail');

emailInput.addEventListener('input', () => {
  if (emailInput.value.trim() !== '') {
    submitButtonEmail.style.display = 'block'; // Show the submit button
  } else {
    submitButtonEmail.style.display = 'none'; // Hide the submit button
  }
});

const fnInput = document.getElementById('fnInput');
const fnBtn = document.getElementById('fnBtn');

fnInput.addEventListener('input', () => {
  if (fnInput.value.trim() !== '') {
    fnBtn.style.display = 'block'; // Show the submit button
  } else {
    fnBtn.style.display = 'none'; // Hide the submit button
  }
});
...
lnInput.addEventListener('input', () => {
  if (lnInput.value.trim() !== '') {
    lnBtn.style.display = 'block'; // Show the submit button
  } else {
    lnBtn.style.display = 'none'; // Hide the submit button
  }
});
